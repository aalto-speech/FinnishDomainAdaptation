...
lmtag="kielipankki_full"              # tag for managing LMs
...
##Then merge kielipankki with parliament transcripts
cat data/all_cleaned/text data/kielipankki/processed_data/${lmtag} > data/parl_kielifull

echo "make a non-linguistic symbol list"
cut -f 2- data/parl_kielifull | tr " " "\n" | sort | uniq | grep "\[" > ${nlsyms}
cat ${nlsyms}
