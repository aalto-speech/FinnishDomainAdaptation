...
train_perturbed=conv-fin-sanasto_train_perturbed
dev_perturbed=dev_perturbed

feat_tr_dir=${dumpdir}/${train_set}/delta${do_delta}; mkdir -p ${feat_tr_dir}
feat_dt_dir=${dumpdir}/${train_dev}/delta${do_delta}; mkdir -p ${feat_dt_dir}


feat_tr_dir_perturbed=${dumpdir}/${train_perturbed}/delta${do_delta}; mkdir -p ${feat_tr_dir_perturbed}
feat_dt_dir_perturbed=${dumpdir}/${dev_perturbed}/delta${do_delta}; mkdir -p ${feat_dt_dir_perturbed}


#Generate features for dev and train perturbed, test remains same
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
    ### Task dependent. You have to design test, training and dev sets by yourself. Data should be in kaldi-style
    ### But you can utilize Kaldi recipes in most cases
    echo "CReate perturbed data"

    utils/data/perturb_data_dir_speed_3way.sh data/${train_set} ${train_perturbed}
    utils/data/perturb_data_dir_speed_3way.sh data/${train_dev} ${dev_perturbed}
